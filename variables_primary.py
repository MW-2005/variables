...
print('my bday is on', bday)
print('my favorite animal at the moment is a', animal,'its always changing')
print()
...
print()
print('my favorite number is', numb, 'commonly known as py')
print('the glorious mounth on which I was born is', month,'the best month')
print('this is a example of a negative number',neg)
print('half can be shown in many forms such as',deci,'or 2/4')
print()
...
print()
print('my middle name is',name, 'so my inicials are M.N.W.')
print('i think it would be cool to be born on',bday,'cause then i would be old enough to remember the 80\'s and the grate movies and music that came out around then ')
print('the number i think is the most innapropreate is',numb,'you know why' )
print()
